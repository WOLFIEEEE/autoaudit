...
COVERAGE: dict[str, CoverageEntry] = {
    ...
    "2.5.1": {"level": "A",   "name": "Pointer Gestures", "tier": "partial",
              "notes": "mobile-pointer-gesture flags path-based and multi-touch handlers. Whether a "
                       "single-pointer alternative exists still needs human review."},
    ...
    "2.5.4": {"level": "A",   "name": "Motion Actuation", "tier": "partial",
              "notes": "mobile-motion-actuation flags devicemotion/deviceorientation listeners. "
                       "Whether a non-motion alternative exists still needs human review."},
